...
export default {
  title:
    'Youtube - Forward/Backward outside buffer of the VP9-1080p60Hz Asset and check for video playback',
  description:
    'Start playback of a VP9-1080p60Hz Asset on YouTube and forward/backward outside the buffer',
  setup() {
