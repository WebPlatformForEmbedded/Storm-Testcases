...
const metrologicalURL = 'https://www.metrological.com/'
...
export default {
  ...
  steps: [
    ...
    },
    {
      ...
      test: setWebKitUrl,
      params: metrologicalURL,
      assert: metrologicalURL,
    },
    {
      ...
      sleep() {
        ...
        return new Promise((resolve, reject) => {
          const interval = setInterval(() => {
            if (this.$data.read('currentUrl') === metrologicalURL) {
    ...
    },
    {
      ...
      sleep() {
        ...
        return new Promise((resolve, reject) => {
          const interval = setInterval(() => {
            if (this.$data.read('currentUrl') === googleURL) {
              clearInterval(interval)
              resolve()
            }
            reject('URL not loaded within time limit')
